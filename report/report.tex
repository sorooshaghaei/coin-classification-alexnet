...
The code and experiments are in the GitHub repository: \href{https://github.com/sorooshaghaei/coin-classification-alexnet}{sorooshaghaei/coin-classification-alexnet}.
}
...
\section{Critics and limits}
Several limitations remain.

First, the task is difficult because many coin classes differ only by subtle symbols, inscriptions, year markings, or metallic texture. AlexNet can solve a large part of the problem, but its feature extractor is less modern than contemporary architectures.
...
The full code and experiment scripts live in the GitHub repository: \href{https://github.com/sorooshaghaei/coin-classification-alexnet}{sorooshaghaei/coin-classification-alexnet}.
